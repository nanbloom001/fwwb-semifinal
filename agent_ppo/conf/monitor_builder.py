...
def build_monitor():
    ...
    for name, key in (
        ...
        ("摆腿小步权重", "w_stair_swing"),
        ("步幅约束权重", "w_stair_stride"),
        ("支撑连续权重", "w_stair_support"),
    ...
    for name, key in (
        ...
        ("摆腿小步奖励", "reward_stair_swing_step_targeting"),
        ("步幅过大惩罚", "reward_stair_stride_length_penalty"),
        ("支撑断档惩罚", "reward_stair_support_continuity_penalty"),
