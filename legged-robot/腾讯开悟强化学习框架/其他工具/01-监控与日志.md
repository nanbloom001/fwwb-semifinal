...
![监控面板](/docs/p-competition-legged_robot_competition_26/22.0.3/assets/images/monitor-b36f1a27afcc1bee7f801f156068211f.png)
...
|  | expr | string | 指标查询表达式，支持指标变量（label） | 使用 PromQL 的查询语法即可 |
...
> 注意：不要重写日志系统：重写后监控面板将无法统计错误日志数量。日志流量限制：框架限制为 60 条/分钟，超出部分将被丢弃。
